---
title: menu
description: Menu component for creating intutive and interactive navigation
img : m5.jpg
...
<div class="preview-component-wrapper" style="min-width:30em;">
<Menu />
</div>
</div>
...
<menu class="menu">
  ...
  <button title="Misc" class="menu__item" style="background: #f54888;">
    <svg class="icon" viewBox="0 0 24 24">
      <path
  ...
  <button title="Science" class="menu__item" style="background: #4343f5;">
    <svg class="icon" viewBox="0 0 24 24">
    ...
    <button title="News" class="menu__item" style="background-color: #e0b115;">
      <svg class="icon" viewBox="0 0 24 24">
        <path
